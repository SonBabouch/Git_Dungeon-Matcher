...
public class DetailsCanvasManagerTuto : MonoBehaviour
{
    ...
    public void UpdateDetailsMenu()
    {
        ...
        if (MenuManagerTuto.Instance.canvasManager.bagCanvas.currentMonsterSelected != null)
        {
            //Description Stuff
            GameObject monsterToShow = MenuManagerTuto.Instance.canvasManager.bagCanvas.currentMonsterSelected;
