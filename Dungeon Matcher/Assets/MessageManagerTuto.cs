...
public class MessageManagerTuto : MonoBehaviour
{
    public static MessageManagerTuto instance;
    ...
    /*[HideInInspector]*/
    public string[] playerIndex1Charged = new string[4];
            ...
            switch (skill.side)
            {
                case SkillTuto.monsterSide.Enemy:
                    ...
                    if (skill.typeOfCapacity == SkillTuto.capacityType.Plagiat)
                    {
                        ...
                        {
                            skill.typeOfCapacity = PlayerTuto.Instance.lastPlayerCompetence.typeOfCapacity;
                            skill.chargingAttack = PlayerTuto.Instance.lastPlayerCompetence.chargingAttack;
                        }
                    }
